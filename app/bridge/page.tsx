...
export default function BridgePage() {
  const [selectedBridge, setSelectedBridge] = useState<"solana" | "eth" | null>(
    null,
  );
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 ">
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Bridge your assets to the Solana network for fast and low-cost
                transactions.
              </p>
              <a
              ...
              >
                <MemeButton className="w-full bg-purple-400 hover:bg-purple-300 border-purple-600">
                  Bridge to Solana 🌊
                </MemeButton>
              </a>
            </div>
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Transfer your assets from Ethereum network to access cross-chain
                opportunities.
              </p>
              <a
                ...
                rel="noopener noreferrer"
              >
                <MemeButton className="w-full bg-blue-400 hover:bg-blue-300 border-blue-600">
                  Bridge from ETH ⚡
                </MemeButton>
              </a>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  All bridge transactions are secured and verified on both
                  chains
                </p>
              </div>
              <div className="space-y-2">
