        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-4">
            {[1, 2, 3].map((index) => (
              <div
                key={index}
                className="bg-white dark:bg-[#0A0F1C] rounded-xl p-6 border-4 border-yellow-400 dark:border-yellow-600"
              >
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold">Proposal #{index}</h3>
                  <span className="px-3 py-1 bg-green-400 text-black rounded-full text-sm border-2 border-green-600">
                    Active 🟢
                  </span>
                </div>
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  Community proposal for platform improvement.
                </p>
